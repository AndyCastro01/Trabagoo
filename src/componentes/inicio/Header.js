    ...
    return (
      <div className="container-fluid ml-1">
        ...
        <nav className="navbar navbar-expand-lg  navbar-light">
          ...
          {/* Icono del Navbar cuando se esconde o se visuliza en el movil */}
          <button
          ...
          {/* Navbar que se visualiza cuando se hace mas pequeña la pantalla */}
          ...
          >
            <ul className="nav mr-auto nav-tabs">
              ...
              {/* Boton para deplegable con las categorias */}
              ...
              <div className="btn-group bg-dark">
                ...
                <ul className="dropdown-menu dropdown-menu-dark">
                  ...
                  <li>
                    <a class="dropdown-item" href="Plomeria">
                      <label>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                  ...
                  <li>
                    <a class="dropdown-item" href="/Programador">
                      <label>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                  ...
                  <li>
                    <a class="dropdown-item" href="/Tecnico">
                      <label>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                  ...
                  <li>
                    <a class="dropdown-item" href="/Mecanico">
                      <label>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
            ...
            {/* Boton para ver opciones o visulizar el perfil */}
          ...
          {/* Buscador Inactivo aun en construccion */}

          {/* <form className="d-flex sm-2">
            <input
