  ...
  return (
    <div className="color">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    Incendio), como es tubería, cableado, equipo y
                    configuración.
                  </p>
                  <a href="" class="btn btn-outline-success btn-sm">
                    {" "}
      ...
      <div className="card text-center row">
        ...
        <div className="card-body col s4 m4">
          <h5 className="card-title txt-card">Todo lo que tu necesitas </h5>
          <p className="card-text txt-card">
          ...
          <a href="#" className="btn btn-primary txt-card">
            Vamos, Ya!
          </a>
        </div>
        <div className="card-footer text-muted txt-card col s4 m4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="26"
            height="26"
          ...
          <br></br>
          <a>©2022 Todos los derechos reservados</a>
        </div>
      </div>
    </div>
  );
